...
object Constants {
    ...
    const val BASE_URL = "http://<IP_ADDRESS>:8080/api/"
    const val WEBSOCKET_URL = "ws://<IP_ADDRESS>:8080/chat"
    const val POST_CODE_URL = "http://<IP_ADDRESS>:8080/postcode"
    const val IMAGE_BASE_URL = "http://<IP_ADDRESS>:8080/upload/board/"
